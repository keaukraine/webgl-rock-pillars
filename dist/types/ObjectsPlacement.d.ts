...
export declare const ROCKS1_XFORM: number[];
export declare const ROCKS2_XFORM: number[];
export declare const ROCKS3_XFORM: number[];
export declare const ROCKS4_XFORM: number[];
export declare const ROCKS5_XFORM: number[];
export declare const TREES_XFORM: number[];
...
export declare const TREES_TEXTURE: Float32Array, TREES_COUNT: number;
